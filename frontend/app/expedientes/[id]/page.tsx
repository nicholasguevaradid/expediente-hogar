    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <a href={`/expedientes/${id}/editar`} className="btn-secondary">
            Editar
          </a>
      ...
      <div className="card">
        ...
        <dl className="grid grid-cols-2 gap-4">
          <Field
            ...
            value={new Date(patient.createdAt).toLocaleString('es-CR')}
          />
          <Field
            label="Última actualización"
            value={new Date(patient.updatedAt).toLocaleString('es-CR')}
          />
        </dl>
      </div>
